...
int main()
{
    ...
    Shader shader = LoadShader("polygon_shading_methods/flat_shading/shading_flat.vs", "polygon_shading_methods/flat_shading/shading_flat.fs");
    ...
    while (!WindowShouldClose())
    {
        ...
        DrawText("Flat Shading", 10, 10, 20, BLACK);
